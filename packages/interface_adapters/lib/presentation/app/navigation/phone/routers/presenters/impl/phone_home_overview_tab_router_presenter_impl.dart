...
import '../../../orchestrator/phone_navigation_orchestrator/phone_navigation_orchestrator.dart';
import '../../views/phone_home_overview_tab_router_view.dart';
import '../phone_home_overview_tab_router_presenter.dart';

class PhoneHomeOverviewTabRouterPresenterImpl
    extends BaseViewStreamablePresenter<PhoneHomeOverviewTabRouterView>
    implements PhoneHomeOverviewTabRouterPresenter {
  PhoneHomeOverviewTabRouterPresenterImpl({
    ...
    final navigatorStackState =
        _navigator.state.homeNavigationState!.tabStackStateMap[PhoneHomeTab.overview]!;
    ...
    final view = PhoneHomeOverviewTabRouterView(
      routes: navigatorStackState.routes,
  ...
  void _onNavigatorStateChanged(ValueWithPrevious<PhoneNavigatorState> valueWithPrevious) {
    ...
    final currentNavigatorStackState =
        currentState.homeNavigationState!.tabStackStateMap[PhoneHomeTab.overview]!;

    final previousNavigatorStackState =
        previousState.homeNavigationState!.tabStackStateMap[PhoneHomeTab.overview]!;
