...
class ShoppingListItemAdditionScreenPresenterImpl extends BaseUpdateStreamablePresenter
  ...
  ShoppingListItemAdditionScreenPresenterImpl({
    ...
    _currentViewPresenter = _shoppingListItemAdditionScreenStatePresenterFactory.create(
  ...
  late ShoppingListItemAdditionScreenStatePresenter _currentViewPresenter;
  ...
  @override
  ShoppingListItemAdditionScreenStatePresenter get currentStatePresenter => _currentViewPresenter;
