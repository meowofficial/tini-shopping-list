...
class MobileHomeAdditionTabRouterDelegate extends RouterDelegate<UriConfig>
    with ChangeNotifier, PopNavigatorRouterDelegateMixin<UriConfig> {
  MobileHomeAdditionTabRouterDelegate({
  ...
  AppNavigatorPage _createNavigatorPage(AppRoute route) {
    ...
    switch (route) {
      case MobileShoppingListItemAdditionRoute():
        // widget = MobileShoppingListItemAdditionScreen(
        //   key: Key(route.id),
        // );
        widget = Container(
          color: Colors.red,
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final stackState = state.homeNavigationState!.tabStackStateMap[MobileHomeTab.addition]!;
        ...
        return Navigator(
          ...
          onDidRemovePage: (page) {
            ...
            _navigatorPresenter.onHomeTabRoutePopped(
              route: route,
              homeTab: MobileHomeTab.addition,
            );
          },
          observers: [
