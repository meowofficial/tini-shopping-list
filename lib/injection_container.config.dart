...
import 'app/application/mappers/shopping_list_overview_flow_state_ref_mapper.dart'
    as _i879;
import 'app/application/stores/app_initialization_store.dart' as _i411;
...
import 'app/interface_adapters/presentation/navigation/mobile/mobile_navigator.dart'
    as _i252;
import 'core/application/stores/user_intent_store.dart' as _i35;
import 'core/application/use_cases/activate_user_intent.dart' as _i308;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i411.AppInitializationStore>(
      () => _i411.AppInitializationStoreImpl(),
    );
    gh.lazySingleton<_i35.UserIntentStore>(() => _i35.UserIntentStoreImpl());
    ...
    gh.lazySingleton<_i648.HandleAppLaunch>(
      () => _i648.HandleAppLaunchImpl(
        shoppingListFlowStore: gh<_i1019.ShoppingListFlowStore>(),
        userIntentStore: gh<_i35.UserIntentStore>(),
      ),
    );
    gh.lazySingleton<_i116.ReadAppInitializationFlowState>(
      () => _i116.ReadAppInitializationFlowStateImpl(
        appInitializationStore: gh<_i411.AppInitializationStore>(),
    ...
    gh.lazySingleton<_i766.ReadActiveUserIntent>(
      () => _i766.ReadActiveUserIntentImpl(
        userIntentStore: gh<_i35.UserIntentStore>(),
      ),
    );
    ...
    gh.lazySingleton<_i308.ActivateUserIntent>(
      () => _i308.ActivateUserIntentImpl(
        userIntentStore: gh<_i35.UserIntentStore>(),
      ),
    );
    gh.lazySingleton<_i1034.WatchActiveUserIntent>(
      () => _i1034.WatchActiveUserIntentImpl(
        userIntentStore: gh<_i35.UserIntentStore>(),
      ),
    );
